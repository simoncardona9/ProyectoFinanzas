        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold">
              Exportar registros financieros
            </h1>
          </div>
          <BackLink href="/settings">Volver a configuración</BackLink>
        </div>
        <p className="mt-3 text-zinc-600">
          Descarga registros fechados del hogar en CSV. La descarga se registra
          en auditoría y no sustituye una copia de respaldo de la base de datos.
        </p>
        <form
          action="/api/v1/reports/export"
          className="mt-6 flex flex-wrap items-end gap-3 rounded-xl border p-4"
        >
