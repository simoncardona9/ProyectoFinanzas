  ...
  return (
    <main className="flex flex-1 justify-center bg-zinc-50 p-6">
      <section className="w-full max-w-5xl rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-950/5">
        ...
        <p className="mt-2 text-zinc-600">Registra ingresos y egresos pagados en pesos uruguayos.</p>
        <TransactionRegister canEdit={["owner", "editor"].includes(context.membership.role)} />
      </section>
    </main>
  );
}
